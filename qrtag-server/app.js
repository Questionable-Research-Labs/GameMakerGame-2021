    ...
    switch (json['message']) {
      ...
      case 'scan':
        ...
        if (type === "player") {
          ...
          let otherPlayer = _.find(state.players.entries(), (val, _index, _array) => {
            console.log(val.value.playerID, json["id"], val.value.playerID === json["id"]); 
            return val.value.playerID === json["id"]});
